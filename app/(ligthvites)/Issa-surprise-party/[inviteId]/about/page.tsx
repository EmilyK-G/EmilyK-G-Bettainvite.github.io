  ...
  return (
    <div className='m-20 flex flex-col content-between items-center h-screen'>
        <div className='text-th-accent-light p-5 landscape:pb-0 flex-1 flex flex-col items-center justify-evenly'>
            ...
            <div className='font-mono font-thin indent-2 leading-relaxed opacity-70 text-5xl landscape:text-3xl'>Nuestros queridos<span className='text-6xl font-semibold'> ancianos </span>
            nos cuidan y nos enseñan con el ejemplo:
              ...
              <small className='text-xl opacity-50'>
        ...
        <button 
          onClick={()=> router.back()}
          className="text-4xl landscape:text-3xl mt-20 landscape:mt-0 pb-10 font-mono font-bold text-mustard landscape:self-end">
          {`...volver`}
        </button>
