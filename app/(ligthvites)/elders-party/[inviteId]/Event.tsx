  ...
  return (
    <div className="flex flex-col items-center justify-start h-full w-full text-th-primary-dark bg-th-primary-light bg-opacity-60 text-center">
      <div className='flex flex-col items-center justify-center flex-1 p-10'>
        <p className='text-6xl landscape:text-4xl m-10 landscape:m-3'>a acompañarnos en la</p>
        <p className='text-9xl landscape:text-8xl font-thin m-10 my-20 laptop:my-12 landscape:my-0'>Fiesta para los Ancianos</p>
        <p className='text-6xl landscape:text-4xl m-10 landscape:m-3'>de este año</p>
        <Link 
      ...
      <div className='flex flex-col items-end justify-center p-10 px-32 bg-th-primary-medium bg-opacity-50 landscape:border-t-2 landscape:border-th-accent-light text-th-primary-light w-full'>
        <p className='text-4xl font-thin mt-0 ml-60'> <small className='text-2xl'>Organizado por</small> Uniondale Spanish</p>
      </div>
    </div>
