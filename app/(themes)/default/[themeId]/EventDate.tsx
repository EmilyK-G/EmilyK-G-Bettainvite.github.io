...
function EventDate() {
  return (
    <div className='h-full w-full bg-th-primary-medium bg-opacity-40 px-20 flex justify-center items-end'>
      <div className='flex flex-col items-center justify-evenly laptop:justify-center text-th-accent-dark p-20 bg-th-primary-light h-full bg-opacity-95 text-center'>
