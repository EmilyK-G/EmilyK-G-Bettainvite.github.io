...
function EventDate() {
  return (
    <div className='h-full w-full bg-brick bg-opacity-50 px-20 flex justify-center items-end'>
      <div className='flex flex-col items-center justify-evenly text-whitesmoke p-10 pb-20 bg-brick bg-opacity-95 text-center'>
