...
function Event(props:any) {
  return (
    <div className={"flex flex-col items-center justify-start h-full w-full text-center font-cinzel" + (props.lightMode ? ' text-th-primary-light' : ' text-th-accent-light')}>
      <div className='flex flex-col items-center justify-around p-10 h-full'>
        ...
        <p className='text-7xl font-sans leading-tight'>Unas palabras de sus amigos de Ecuador, que aunque están lejos, los recuerdan con cariño ♥ ...</p>
        {/* <Link 
