...
function Event() {
  return (
    <div className="flex flex-col items-center justify-center h-full text-black bg-th-primary-light bg-opacity-60 text-center">
      ...
      <div className='flex flex-col items-end justify-center p-10 px-32 bg-th-primary-medium bg-opacity-50 text-darknavy w-full'>
